SHELL=cmd
STRIPE_SECRET=sk_test_51MqFLqLrHUTiMWLdVx3Rbk6So0NZqELGBqmJVRezU8aqFdSwdJxdLaQDSk5265MG1Ghg9NKtURQP2NCywcTMVNZL00ucAvxOjQ
STRIPE_KEY=pk_test_51MqFLqLrHUTiMWLdqCzdXAXEQT3ALebY8LOb8h7zHIeyzHOsmLfpX36MzajFVeKRgVJ4P6VsZJHY7qZzQ2jwj59b00wmLfWShN
GOSTRIPE_PORT=4000
API_PORT=4001
DSN="root:root@(localhost:3306)/widgets?parseTime=true&tls=false"
...
start_invoice: build_invoice
	...
	set STRIPE_KEY=${STRIPE_KEY}&& set STRIPE_SECRET=${STRIPE_SECRET}&& start /B .\dist\invoice.exe
